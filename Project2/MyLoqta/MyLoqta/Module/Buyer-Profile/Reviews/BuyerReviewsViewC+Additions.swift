//
//  BuyerReviewsViewC+Additions.swift
//  MyLoqta
//
...
extension BuyerReviewsViewC: UITableViewDataSource, UITableViewDelegate {
    ...
    func configureCellForReviews(tableView: UITableView, indexPath: IndexPath) -> ManageStoreReviewsTableCell {
        ...
        cell.delegate = self
        cell.configureCellForMyReviews(review: review)
        return cell
    }
...
extension BuyerReviewsViewC: ManageStoreReviewsTableCellDelegate {
